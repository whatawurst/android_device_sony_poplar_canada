...
This repository is for LineageOS 20.0 on Sony Xperia XZ1 Canada variant (poplar_canada).
...
* Create a local manifest:
        ...
        <manifest>
            ...
            <project name="whatawurst/android_device_sony_poplar_canada" path="device/sony/poplar_canada" remote="github" revision="lineage-20" />
            ...
            <project name="whatawurst/android_vendor_sony_poplar_canada" path="vendor/sony/poplar_canada" remote="github" revision="lineage-20" />
        </manifest>
